...
class CurrTotal(ProgressBarWidget):
    "Returns someting like: 54/100 (54 from a total of 100)"
    def update(self, pbar):
        return "%i/%i"% (pbar.currval, pbar.maxval)
...
if __name__=='__main__':
    ...
    def example2():
        ...
        widgets = [CurrTotal(),' <<<', Bar(), '>>> ', Percentage(),' ', ETA()]
        pbar = ProgressBar(widgets=widgets, maxval=126)
        # maybe do something
        pbar.start()
        for i in range(126):
            # do something
